...
<!-- 
<footer class="bg-[#0e0e0e]" aria-labelledby="footer-heading">
  ...
  <div class="mx-auto max-w-7xl py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
    <div class="mt-8 border-t border-gray-700 pt-8 md:flex md:items-center md:justify-between">
      ...
      <p class="mt-8 text-base text-gray-400 md:order-1 md:mt-0">&copy; 2023 E-sports zs14 designed and created by RGBpc.pl</p>
    </div>
  </div>
</footer> -->
