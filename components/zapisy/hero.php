            ...
            <div class="mx-auto max-w-3xl">
                ...
                <div class="flex flex-col gap-4">
                    ...
                    <div class="relative rounded-md border theme-border shadow-sm transition-all duration-300">
                        ...
                        <div class="bg-[#0e0e0e] px-3 py-2 rounded-md break-words block w-full border-0 p-0 text-gray-400 font-[poppins] focus:ring-0 focus:outline-0 sm:text-sm transition-all duration-300">
