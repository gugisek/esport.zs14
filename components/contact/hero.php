...
<section id="bg" class="bg-cover bg-fixed">
    <section class="pt-4 bg-[#000000c0]">
       ...
       <section data-aos="fade-up" class="bg-black/80 font-[poppins] text-gray-400 py-8 py-4 px-[5%] md:px-[10%] text-justify">
            <div class="mx-auto my-20 max-w-lg space-y-16">
                <div data-aos="fade-right" data-aos-delay="100" data-aos-anchor-placement="top-bottom" class="flex sm:flex-row flex-col gap-x-6">
                    <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg theme-bg sm:mb-0 mb-4">
                ...
                <div data-aos="fade-right" data-aos-delay="200" data-aos-anchor-placement="top-bottom" class="flex sm:flex-row flex-col gap-x-6">
                    <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg theme-bg sm:mb-0 mb-4">
                        <svg class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
                ...
                <div data-aos="fade-right" data-aos-delay="300" data-aos-anchor-placement="top-bottom" class="flex sm:flex-row flex-col gap-x-6">
                    <div class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg theme-bg  sm:mb-0 mb-4">
                        <svg class="h-6 w-6 text-white" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
