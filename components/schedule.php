                        ...
                        <div class="bg-[#0e0e0e] px-4 pb-4 rounded-b-xl w-full">
                            <table class="w-full">
                                ...
                                <tr class="border-b-[1px]  border-gray-600 hover:bg-[#232323]">
                                    ...
                                    <td class="text-sm font-[poppins] theme-text text-center">3</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">0</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">87</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">59</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">28</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">9</td>
                                </tr>
                                <tr class="border-b-[1px] border-t-[1px] border-gray-600 hover:bg-[#232323]">
                                    <td class="font-[poppins] text-sm text-gray-300 py-2 text-ellipsis">Zabrakło Cala <span class="text-gray-600 text-xs">4i</span></td>
                                    ...
                                    <td class="text-sm font-[poppins] theme-text text-center">33</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">6</td>
                                </tr>
                                <tr class="border-b-[1px] border-gray-600 hover:bg-[#232323]">
                                    <td class="font-[poppins] text-sm text-gray-300 py-2 text-ellipsis">ELTK <span class="text-gray-600 text-xs">2p</span></td>
                                    ...
                                    <td class="text-sm font-[poppins] theme-text text-center">1</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">2</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">54</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">58</td>
                                ...
                                <tr class=" hover:bg-[#232323]">
                                    ...
                                    <td class="text-sm font-[poppins] theme-text text-center">0</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">3</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">18</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">77</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">-59</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">0</td>
                                </tr>  
                            </table>
                        ...
                        <div class="bg-[#0e0e0e] px-4 pb-4 rounded-b-xl w-full">
                            <table class="w-full">
                                ...
                                <tr class="border-b-[1px] border-t-[1px] border-gray-600 hover:bg-[#232323]">
                                    ...
                                    <td class="text-sm font-[poppins] theme-text text-center">13</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">65</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">9</td>
                                </tr>
                                <tr class="border-b-[1px] border-t-[1px] border-gray-600 hover:bg-[#232323]">
                                    <td class="font-[poppins] text-sm text-gray-300 py-2 text-ellipsis">UHO BOYS <span class="text-gray-600 text-xs">3gt</span></td>
                                    ...
                                    <td class="text-sm font-[poppins] theme-text text-center">2</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">1</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">72</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">60</td>
                                ...
                                <tr class="border-b-[1px]  border-gray-600 hover:bg-[#232323]">
                                    ...
                                    <td class="text-sm font-[poppins] theme-text text-center">66</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">-29</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">3</td>
                                </tr>
                                <tr class=" hover:bg-[#232323]">
                                    <td class="font-[poppins] text-sm text-gray-300 py-2 text-ellipsis">KOKENERGY <span class="text-gray-600 text-xs">5pi</span></td>
                                    ...
                                    <td class="text-sm font-[poppins] theme-text text-center">87</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">-48</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">0</td>
                                </tr>
                        ...
                        <div class="bg-[#0e0e0e] px-4 pb-4 rounded-b-xl w-full">
                            <table class="w-full">
                                ...
                                <tr class="border-b-[1px] border-t-[1px] border-gray-600 hover:bg-[#232323]">
                                    ...
                                    <td class="text-sm font-[poppins] theme-text text-center">64</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">9</td>
                                </tr>
                                <tr class="  hover:bg-[#232323]">
                                    <td class="font-[poppins] text-sm text-gray-300 py-2 text-ellipsis">JUK ESPORT <span class="text-gray-600 text-xs">2e</span></td>
                                    ...
                                    <td class="text-sm font-[poppins] theme-text text-center">2</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">1</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">69</td>
                                ...
                                <tr class=" border-t-[1px] border-b-[1px] border-gray-600 hover:bg-[#232323]">
                                    ...
                                    <td class="text-sm font-[poppins] theme-text text-center">1</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">2</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">67</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">75</td>
                        ...
                        <div class="bg-[#0e0e0e] px-4 pb-4 rounded-b-xl w-full">
                            <table class="w-full">
                                ...
                                <tr class="border-b-[1px] border-gray-600 hover:bg-[#232323]">
                                    ...
                                    <td class="text-sm font-[poppins] theme-text text-center">3</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">1</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">112</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">56</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">56</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">9</td>
                                </tr>
                                ...
                                <tr class="hover:bg-[#232323]">
                                    ...
                                    <td class="text-sm font-[poppins] theme-text text-center">4</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">0</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">104</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">-104</td>
                                    <td class="text-sm font-[poppins] theme-text text-center">0</td>
                                </tr> 
                            </table>
                ...
                <section id="schedule_cs_2" class="schedule_cs duration-300 h-0 w-0 opacity-0 grid 2xl:grid-cols-3 lg:grid-cols-3 md:grid-cols-2 gap-8 2xl:divide-x lg:divide-x divide-slate-700">
                    <div class="grid grid-rows-4 gap-10">
                        ...
                        <div class="flex flex-col items-center border-[1px] border-gray-200 justify-between h-fit">
                            ...
                            <hr>
                            <div class="px-4 bg-slate-200 flex flex-row items-center justify-between w-full">
                                <p class="text-sm font-bold text-slate-800 py-2 font-[poppins] italic">Zabrakło Cala <span class="text-gray-600 text-xs">4i</span></p>
                                <p class="text-sm font-bold text-slate-800"></p>
                            </div>
                        </div>
                        <div class="flex flex-col items-center border-[1px] border-gray-200 justify-between h-fit">
                ...
                <div class="bg-[#0e0e0ec0] py-4 px-4 h-full w-full rounded-2xl flex flex-col justify-between">
                    <div>
                        ...
                        <!-- <div class=" text-gray-200   border-[#3d3d3d] py-2 flex items-center justify-between">
                            <div>
                                <h1 class="font-[poppins] font-semibold">KOKENERGY <span class="text-gray-600 text-xs">5pi</span> vs TurlajBeczke <span class="text-gray-600 text-xs">5pi</span></h1>
                                <p class="uppercase theme-text font-[poppins] text-xs">Faza Grupowa | Runda 3 | Grupa <span class="theme-text">B</span></p>
                            </div>
                            <div>
