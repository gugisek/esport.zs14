      ...
      >
        <div class="flex flex-col-reverse">
          <div class="mt-4">
            ...
            <p data-aos="fade-right" data-aos-delay="200" class="mt-2 text-sm text-gray-500">
              Edycja pierwsza (Zaktualizowano
              <time datetime="2021-06-05">Listopad 27, 2023</time>)
            </p>
          </div>
        </div>

        <p data-aos="fade-right" data-aos-delay="300" data-aos-anchor-placement="none" class="mt-6 text-gray-400">
          Jest to pierwsza edycja turnieju w grę Counter Strike: Global Offensive w naszej szkole!
          Zawodnicy będą rywalizować o tytuł najlepszej drużyny w szkole przy tym propagować ducha fair play i dobrej zabawy.
        </p>
        ...
        <div data-aos="fade-right" data-aos-delay="500" class="mt-10 border-t border-[#3d3d3d] pt-10">
          ...
          <p class="mt-4 text-sm text-gray-400">
            Gra będzie się toczyć w 3 fazach:
            <br />
            - faza grupowa - zdalnie <br />
            - drabinka szwecka - zdalnie <br />
            - finały - stacjonarnie
          </p>
        </div>
        <!-- terminy -->
        <div data-aos="fade-right" data-aos-delay="600" class="mt-10 border-t border-[#3d3d3d] pt-10">
          ...
          <p class="mt-4 text-sm text-gray-400">
            Zgłoszenia są przyjmowane do
            <span class="theme-text">31 grudnia 2023</span>. <br /><br />
            Faza grupowa rozpocznie się
            <span class="theme-text">1 stycznia 2024</span>, będzie trwać przez
            kolejne 2 tygodnie. <br /><br />
            Drabinka szwecka rozpocznie się
            <span class="theme-text">15 stycznia 2024</span>, będzie trwać przez
            kolejne 2 tygodnie. <br /><br />
            Finał odbędzie się dnia
            <span class="theme-text">2 lutego 2024</span> roku podczas dnia
            informatyka.
          </p>
        </div>
        <!-- nagrody -->
        ...
        <div class="mt-10 border-t border-[#3d3d3d] pt-10">
          ...
          <p class="mt-4 text-sm text-gray-400">
            Organizator przewiduje maksymalnie dwie drużyny z jednej klasy.
            <br /><br />
            W drużynie może być maksymalnie
            <span class="theme-text">5 osób</span> oraz może być rezerwowy.
          </p>
        </div>
        <!-- wymogi -->
        <div class="mt-10 border-t border-[#3d3d3d] pt-10">
          ...
          <p class="mt-4 text-sm text-gray-400">
            - Oryginalna licencja gry CS:GO <br />
            - Komputer z dostępem do internetu <br />
            - Konta: steam oraz discord <br />
