<section class="w-full px-[5%] md:px-[10%] 2xl:px-[15%] pb-12 pt-12 flex flex-col items-center">
    <div class="border-b-[1px] border-gray-300 uppercase text-sm flex px-8 flex-row gap-4 2xl:text-lg">
        <a onclick="openWinners('cs')" class="cursor-pointer font-[poppins] theme-text font-medium">CS2</a>
        <a onclick="openWinners('lol')" class="cursor-pointer font-[poppins] font-medium text-gray-600 theme-text-hover duration-300">LoL</a>
        <a onclick="openWinners('events')" class="cursor-pointer font-[poppins] font-medium text-gray-600 theme-text-hover duration-300">Eventy</a>
    </div>
    <h1 class="text-2xl md:text-3xl font-bold font-[poppins] text-center 2xl:text-4xl text-gray-800 py-[2px]">OSTATNI ZWYCIĘZCY</h1>
    <div id="winners_cs" class="winners border-b-[1px] border-gray-200 grid md:grid-cols-4 grid-cols-2 gap-8">
        <div class="col-span-2 py-2 pb-4 mt-12">
        ...
        <div class="flex col-span-2 flex-col justify-center">
            <p class="font-[poppins] 2xl:text-base text-xs theme-text">Styczeń 2022</p>
            <h2 class="text-gray-800 2xl:text-2xl 2xl:font-bold font-medium font-[poppins]">Turniej ZS14 Globalna Ofensywa 2022</h2>
            <p class="text-gray-600 font-[poppins] 2xl:text-lg text-sm">
            ...
            <a href="events.php" class="2xl:text-base text-xs theme-text-hover items-center flex flex-row gap-2 my-2 uppercase font-[poppins] font-medium text-gray-700 hover:text-black duration-300">
    ...
    <div id="winners_lol" class="winners duration-300 h-0 w-0 opacity-0 border-b-[1px] border-gray-200 grid grid-cols-4 gap-8">
        <div class="col-span-2 py-2 pb-4 mt-12">
            <img src="public/img/winners_example.jpg" alt="" class="w-full shadow-xl rounded-xl">
            <h1 style="text-shadow: 0px 5px 10px black;" class="text-4xl font-[poppins] text-gray-50 italic font-bold -mt-6 text-center">9ine ESPORTS</h1>
        </div>
    ...
    <div id="winners_events" class="winners duration-300 h-0 w-0 opacity-0 border-b-[1px] border-gray-200 grid grid-cols-4 gap-8">
        <div class="col-span-2 py-2 pb-4 mt-12">
            <img src="public/img/winners_example.jpg" alt="" class="w-full shadow-xl rounded-xl">
            <h1 style="text-shadow: 0px 5px 10px black;" class="text-4xl font-[poppins] text-gray-50 italic font-bold -mt-6 text-center">9ine ESPORTS</h1>
        </div>
...
<script>
    ...
    function openWinners(page) {
        var sections = document.querySelectorAll("div.winners");
