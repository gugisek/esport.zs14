        ...
        <div class="2xl:px-[15%] md:px-[10%] px-[5%]">
            <div class="grid grid-cols-1 items-center gap-x-8 gap-y-16 lg:grid-cols-2">
                <form action="scripts/settings/edit_sponsors.php" method="POST" data-aos="fade-right" data-aos-delay="100" class="mx-auto w-full max-w-xl lg:mx-0">
                    <input required name="title" class="hover:outline-2 hover:outline-dashed hover:outline-[var(--text)] cursor-pointer text-3xl font-bold tracking-tight text-white pb-6 w-full focus:outline-0 invalid:border-red-600 focus:border-b-[1px] theme-border mb-[1px] focus:mb-0 focus:text-white  bg-[#0e0e0e]/0 mt-1 text-sm leading-6 text-gray-400 sm:col-span-2 sm:mt-0" value="<?=$sponsors[0]?>">
                    <textarea name="description" required rows="3" class="hover:outline-2 hover:outline-dashed hover:outline-[var(--text)] cursor-pointer leading-6 text-gray-300 w-full focus:outline-0 invalid:border-red-600 focus:border-b-[1px] theme-border mb-[1px] focus:mb-0 focus:text-white bg-[#0e0e0e]/0 text-sm leading-6 text-gray-400 sm:col-span-2 sm:mt-0"><?=$sponsors[1]?></textarea>
