...
?>
   <section class="w-full rounded-3xl md:px-0 px-4 pb-4">
        <div class="w-full flex justify-between items-center">
            <h1 class="pb-2 font-medium text-gray-200 font-[Lexend]">Szczegóły</h1>
            <a onclick="popupLogOpenClose()" class="cursor-pointer flex items-center space-x-2 text-gray-500 hover:text-red-600 transition-all duration-300">
        ...
        <div class="flex flex-col md:flex-row md:space-x-4">
            <div class="flex flex-col w-full md:w-1/2">
                <div class="flex flex-col md:flex-row gap-2">
                    <div class="flex flex-col w-full md:w-1/2">
                        <div class="flex flex-col">
                            <label for="user_id" class="pb-2 pt-2 font-medium text-xs text-[#5d5d5d] font-[Lexend]">Użytkownik</label>
                    ...
                    <div class="flex flex-col w-full md:w-1/2">
                        <div class="flex flex-col">
                            <label for="when" class="pb-2 pt-2 font-medium text-xs text-[#5d5d5d] font-[Lexend]">Kiedy</label>
                ...
                <div class="flex flex-col">
                    <label for="object_id" class="pb-2 font-medium pt-2 text-xs text-[#5d5d5d] font-[Lexend]">Id obiektu</label>
                ...
                <div class="flex flex-col">
                    <label for="object_type" class="pb-2 pt-2 font-medium text-xs text-[#5d5d5d] font-[Lexend]">Typ obiektu</label>
                ...
                <div class="flex flex-col">
                    ...
                    <div name="before" id="before" cols="30" rows="5" class="text-sm border border-[#3d3d3d] bg-[#0e0e0e] text-gray-300 rounded-xl px-4 py-2 focus:outline-none focus:border-indigo-500 transition-all duration-500" disabled><?php echo $before; ?></div>
                </div>
                <div class="flex flex-col">
                    <label for="after" class="pb-2 pt-2 font-medium text-xs text-[#5d5d5d] font-[Lexend]">Po</label>
                    <div name="after" id="after" cols="30" rows="5" class="text-sm border border-[#3d3d3d] bg-[#0e0e0e] text-gray-300 rounded-xl px-4 py-2 focus:outline-none focus:border-indigo-500 transition-all duration-500" disabled><?php echo $after; ?></div>
                </div>
            </div>
            <div class="flex flex-col w-full md:w-1/2">
                <div class="flex flex-col">
                    <label for="type" class="pb-2 font-medium text-xs pt-2 text-[#5d5d5d] font-[Lexend]">Nazwa obiektu</label>
                    ...
                    ?>" class="border border-[#3d3d3d] bg-[#0e0e0e] rounded-xl px-4 py-2 focus:outline-none focus:border-indigo-500 transition-all duration-500 text-sm" disabled>
                </div>
                <div class="flex flex-col">
                    <label for="type" class="pb-2 text-xs pt-2 font-medium text-[#5d5d5d] font-[Lexend]">Typ operacji</label>
                ...
                <div class="flex flex-col">
                    <label for="description" class="pb-2 text-xs pt-2 font-medium text-[#5d5d5d] font-[Lexend]">Opis</label>
                    <textarea name="description" id="description" cols="30" rows="10" class="text-sm border border-[#3d3d3d] bg-[#0e0e0e] text-gray-300 rounded-xl px-4 py-2 focus:outline-none focus:border-indigo-500 transition-all duration-500" disabled><?php echo $description; ?></textarea>
                </div>
            </div>
        </div>
    </section>