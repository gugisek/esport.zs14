                ...
                <?php
                  ...
                  if (mysqli_num_rows($result) > 0) {
                    while($row = mysqli_fetch_assoc($result)) {
                      ...
                      $sql2 = "select teams.name, teams.class, teams.profile_img, team_status.name as status from teams join team_status on team_status.status_id=teams.status_id where group_id = '".$row['group_id']."'";
